...
import { ClubemberTheme, tabs } from '../constants';
      ...
      <Block flex style={styles.group}>
        ...
        >
          <Input
            ...
            style={{
              borderColor: ClubemberTheme.COLORS.INFO,
              borderRadius: 4,
              backgroundColor: '#fff'
            }}
            iconContent={<Block />}
        ...
        <Block>
          ...
          <Block style={{ marginBottom: theme.SIZES.BASE }}>
            <Header
              ...
              title="Title"
              navigation={this.props.navigation}
              bgColor={ClubemberTheme.COLORS.ACTIVE}
              titleColor="white"
              iconColor="white"
            />
          </Block>
...
const styles = StyleSheet.create({
  ...
  inputDefault: {
    borderBottomColor: ClubemberTheme.COLORS.PLACEHOLDER
  },
  inputTheme: {
    borderBottomColor: ClubemberTheme.COLORS.PRIMARY
  },
  inputInfo: {
    borderBottomColor: ClubemberTheme.COLORS.INFO
  },
  inputSuccess: {
    borderBottomColor: ClubemberTheme.COLORS.SUCCESS
  },
  inputWarning: {
    borderBottomColor: ClubemberTheme.COLORS.WARNING
  },
  inputDanger: {
    borderBottomColor: ClubemberTheme.COLORS.ERROR
  },
  social: {
