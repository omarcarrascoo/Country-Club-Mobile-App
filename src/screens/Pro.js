          ...
          <Block space="between" style={styles.padded}>
            <Block>
              ...
              <Text
                ...
                style={{ marginTop: 35 }}
              >
                Take advantage of all the features and
                screens made upon Galio Design System, coded
              ...
              <Button
                shadowless
                style={styles.button}
                color={ClubemberTheme.COLORS.INFO}
                onPress={() =>
                  Linking.openURL(
...
const styles = StyleSheet.create({
  ...
  pro: {
    backgroundColor: ClubemberTheme.COLORS.INFO,
    paddingHorizontal: 8,
    marginLeft: 3,
    borderRadius: 4,
    height: 22,
